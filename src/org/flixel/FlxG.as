package org.flixel
{
	...
	public class FlxG
	{
		...
		static public var followZoom:Number;
		...
		public static var FlxSave:SharedObject = SharedObject.getLocal("skydungeon");
		...
		static public function addBitmap(Graphic:Class,Reverse:Boolean=false):BitmapData
		{
			...
			if(needReverse)
			{
				pixels = addReverse(pixels);
			}
			return pixels;
		}
		
		//@desc		Separates out the reverse image adding stuff
		//@param	Pixels		The imagedata to add a reversed bit to
		public static function addReverse(Pixels:BitmapData):BitmapData
		{
